...
class ProfilePage extends StatefulWidget {
  const ProfilePage({this.userId, this.currentUserId});

  final String userId, currentUserId;

  _ProfilePage createState() => _ProfilePage(this.userId, this.currentUserId);
}
...
class _ProfilePage extends State<ProfilePage>
  ...
  //   setState(() {
  //     // if()
  //     this.currentUserId = user.uid.toString();
  //   });
  // }
  ...
  Widget build(BuildContext context) {
    ...
    Container buildProfileFollowButton(User user) {
      ...
      if (currentUserModel.id == profileId) {
        return buildFollowButton(
          text: "Edit Profile",
          backgroundcolor: Colors.white,
          textColor: Colors.black,
